    ...
    <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
      {!isLast ? (
        ...
        <>
          ...
          <Link to="/" className="cursor-pointer items-center rounded-xl border-2 border-blue-400 bg-blue-500 text-white hover:bg-blue-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-400 focus-visible:ring-offset-2 transition-colors">
